...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'LOGIN' => ['type' => 'string', 'length' => 10, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'users_ibfk_1' => ['type' => 'foreign', 'columns' => ['NUM_FEUILLES'], 'references' => ['feuilles', 'ID'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
