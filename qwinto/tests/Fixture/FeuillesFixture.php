...
class FeuillesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'feuilles_ibfk_1' => ['type' => 'foreign', 'columns' => ['NUM_PARTY'], 'references' => ['parties', 'ID'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'feuilles_ibfk_2' => ['type' => 'foreign', 'columns' => ['USER_ID'], 'references' => ['users', 'ID'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
