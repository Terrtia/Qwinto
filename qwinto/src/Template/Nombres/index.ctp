    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $nombre->ID]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $nombre->ID]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $nombre->ID], ['confirm' => __('Are you sure you want to delete # {0}?', $nombre->ID)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
